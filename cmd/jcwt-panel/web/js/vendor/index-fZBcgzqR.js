import { L as k, E as $, a as z } from "./index-DqiFCfGx.js";
import { J as R, Q as t, f as Y, L as W, y as Z, q as x, w as G, v as _, O as V, i as E, I as U } from "./CodeMirrorEditor-Cqow8ROO.js";
...
const v = (e, r, i) => (O, a) => {
  ...
  "[ ]": t.squareBracket,
  "{ }": t.brace
}), ie = { __proto__: null, lang: 44, "nth-child": 44, "nth-last-child": 44, "nth-of-type": 44, "nth-last-of-type": 44, dir: 44, "host-context": 44, if: 90, url: 132, "url-prefix": 132, domain: 132, regexp: 132 }, ne = { __proto__: null, or: 104, and: 104, not: 112, only: 112, layer: 186 }, se = { __proto__: null, selector: 118, layer: 182 }, de = { __proto__: null, "@import": 178, "@media": 190, "@charset": 194, "@namespace": 198, "@keyframes": 204, "@supports": 216, "@scope": 220, "@font-feature-values": 226 }, Qe = { __proto__: null, to: 223 }, ce = k.deserialize({
  version: 14,
  ...
  specialized: [{ term: 137, get: (e) => ie[e] || -1 }, { term: 138, get: (e) => ne[e] || -1 }, { term: 4, get: (e) => se[e] || -1 }, { term: 28, get: (e) => de[e] || -1 }, { term: 136, get: (e) => Qe[e] || -1 }],
  tokenPrec: 2256
});
let p = null;
function u() {
...
const y = /* @__PURE__ */ [
  ...
  "visited",
  "where"
].map((e) => ({ type: "class", label: e })), g = /* @__PURE__ */ [
  "above",
  "absolute",
  "activeborder",
  "additive",
  ...
  "u",
  "ul"
].map((e) => ({ type: "type", label: e })), pe = /* @__PURE__ */ [
  "@charset",
  "@color-profile",
  "@container",
  "@counter-style",
  ...
  "@supports",
  "@view-transition"
].map((e) => ({ type: "keyword", label: e })), d = /^(\w[\w-]*|-\w[\w-]*|)$/, ue = /^-(-[\w-]*)?$/;
function je(e, r) {
  var i;
...
const h = /* @__PURE__ */ new E(), me = ["Declaration"];
function Se(e) {
  for (let r = e; ; ) {
    if (r.type.isTop)
      return r;
...
function w(e, r, i) {
  if (r.to - r.from > 4096) {
    ...
    if (O)
      return O;
    let a = [], o = /* @__PURE__ */ new Set(), l = r.cursor(U.IncludeAnonymous);
    if (l.firstChild())
      do
        for (let n of w(e, l.node, i))
...
const ye = (e) => (r) => {
  ...
  if (a.name == "ValueName")
    return { from: a.from, options: g, validFor: d };
  if (a.name == "PseudoClassName")
    return { from: a.from, options: y, validFor: d };
  ...
  if (a.name == "AtKeyword")
    return { from: a.from, options: pe, validFor: d };
  if (!r.explicit)
    return null;
  let l = a.resolve(O), n = l.childBefore(O);
  return n && n.name == ":" && l.name == "PseudoClassSelector" ? { from: O, options: y, validFor: d } : n && n.name == ":" && l.name == "Declaration" || l.name == "ArgList" ? { from: O, options: g, validFor: d } : l.name == "Block" || l.name == "Styles" ? { from: O, options: u(), validFor: d } : null;
}, ge = /* @__PURE__ */ ye((e) => e.name == "VariableName"), f = /* @__PURE__ */ W.define({
  name: "css",
...
function Pe() {
  return new Y(f, f.data.of({ autocomplete: ge }));
}
export {
  Pe as css,
  ge as cssCompletionSource,
  f as cssLanguage,
  ye as defineCSSCompletionSource
};
