                    ...
                    <div class="table-container">
                        <table class="data-table responsive-cards has-actions">
                            ...
                            <tbody>
                                ${dbList.map(d => `
                                <tr>
                                    <td data-label="Database" class="mono"><strong>${escapeHtml(d.db_name)}</strong> <span class="copy-name" data-name="${escapeHtml(d.db_name)}" class="copy-btn-inline" title="Copy to clipboard"><span class="nav-icon nav-icon-sm">${icons.copy}</span></span></td>
                    ...
                    <div class="table-container">
                        <table class="data-table responsive-cards has-actions">
                            ...
                            <tbody>
                                ${userList.map(u => `
                                <tr>
                                    <td data-label="Username" class="mono"><strong>${escapeHtml(u.username)}</strong> <span class="copy-name" data-name="${escapeHtml(u.username)}" class="copy-btn-inline" title="Copy to clipboard"><span class="nav-icon nav-icon-sm">${icons.copy}</span></span></td>
                                    <td data-label="Database" class="mono">${escapeHtml(u.db_name)} <span class="copy-name" data-name="${escapeHtml(u.db_name)}" class="copy-btn-inline" title="Copy to clipboard"><span class="nav-icon nav-icon-sm">${icons.copy}</span></span></td>
